...
describe('Middleware tests', function () {
    ...
    it('Should register two middlewares and be executed first one, ant then the other one.', function () {
        ...
        const txtAdded2 = ' - preHandler - - preHandler - - handler - - postHandler - - postHandler -';
    ...
    it('Should send options through the middlewares till the handler same each time.', function () {
    ...
    it(
        'Should throw exception if we want to create an instance of Middleware class.', function () {
